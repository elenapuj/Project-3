...
ax.scatter3D(x_1, y_1, z_1, cmap='Greens')
...
plt.savefig("Problem_9d_plot_coulomb1.pdf")

plt.figure()
ax = plt.axes(projection='3d')
ax.scatter3D(x_2, y_2, z_2, cmap='Greens')
...
plt.savefig("Problem_9d_plot_coulomb2.pdf")
